...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="{{ route('front.index') }}">Mentor</a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="{{ route('front.index') }}" class="logo me-auto"><img src="{{ asset('front/assets/img/logo.png') }}" alt="" class="img-fluid"></a>-->

      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          <li><a href="{{ route('front.index') }}">Home</a></li>
          <li><a class="active" href="{{ route('front.blogs') }}">Blogs</a></li>
        </ul>
